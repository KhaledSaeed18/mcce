...
const BRAND_CLASSES =
  "group flex h-8 items-center gap-2 rounded border-2 bg-card py-1 pr-3 pl-2 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-primary hover:text-primary-foreground hover:shadow-md active:translate-y-0 active:shadow-none";
